...
#if defined(CONFIG_ZRAM_UNLIMITED_WRITEBACK)
	ZRAM_WRITEBACK_UNLIMITED, /* page allowed to writeback without the normal quota limit */
#endif
#endif
	__NR_ZRAM_PAGEFLAGS,
};
...
struct zram_table_entry {
	...
	unsigned long flags;
#if defined(CONFIG_ZRAM_MEMORY_TRACKING) || defined(CONFIG_ZRAM_OPT_STATS)
	ktime_t ac_time;
#endif
};
...
#ifdef CONFIG_ZRAM_UNLIMITED_WRITEBACK
